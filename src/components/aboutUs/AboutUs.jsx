            ...
            <Grid size={{ xs: 12, md: 7 }}>
              ...
              >
                <Box>
                  ...
                  >
                    Empower Your Transition: Bridging Skills for Corporate
                    Success
                  </Typography>
                  <Divider
                    sx={{
              ...
              {isFullPage ? (
                <>
                  ...
                  <Typography
                    ...
                    letterSpacing={1}
                  >
                    Join us on this journey to shape the future of
                    work—together, we can create pathways to success.
                  </Typography>
                </>
              ) : (
                <Button
                ...
                {activeContent === "company" && (
                  <>
                    <Typography
                      ...
                      sx={{ mb: 2, mt: 1 }}
                    >
                      At groMind Academy, we offer companies exclusive access to
                      a pool of highly trained talent from premier institutes.
                      Our expertise lies in transforming these individuals into
                      world-class professionals, seamlessly integrating them
                      into organizations as full-time, distributed team members.
                    </Typography>
                    <Typography
                      fontSize={{ xs: 14, sm: 16 }}
                      fontWeight={400}
                      ...
                      sx={{ mb: 2, mt: 1 }}
                    >
                      We empower innovative start-ups and established tech
                      giants to tap into the vast, untapped talent pool across
                      India, significantly reducing the time spent on
                    ...
                    <Typography
                      ...
                      sx={{ mb: 2, mt: 1 }}
                    >
                      We position ourselves not only as a talent provider but as
                      a strategic partner for companies. With our support,
                      organizations can fulfill both their immediate hiring
                      requirements and their long-term talent strategies,
                ...
                {activeContent === "candidate" && (
                  <>
                    ...
                    >
                      ...
                      mentorship not only enhances learning but ensures that
                      each individual is equipped to be job-ready from day one.
                    </Typography>
                    <Typography
                      fontSize={{ xs: 14, sm: 16 }}
                      fontWeight={400}
                      ...
                      sx={{ mb: 2, mt: 1 }}
                    >
                      Our innovative programs bridge the gap between education
                      and employment, preparing you to thrive in today’s
                      competitive job market. Whether you’re starting your
                      career or looking to upskill, groMind Academy is here to
